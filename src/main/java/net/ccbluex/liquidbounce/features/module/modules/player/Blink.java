...
public class Blink extends Module {
    ...
    private final IntegerValue redColorValue = new IntegerValue("Color-Red", 255, 0, 255);
    private final IntegerValue greenColorValue = new IntegerValue("Color-Green", 255, 0, 255);
    private final IntegerValue blueColorValue = new IntegerValue("Color-Blue", 255, 0, 255);
    ...
    public void onRender3D(Render3DEvent event) {
        final Color color = new Color(redColorValue.get(), greenColorValue.get(), blueColorValue.get());

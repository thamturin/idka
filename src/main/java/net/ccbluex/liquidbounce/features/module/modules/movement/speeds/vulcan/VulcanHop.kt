...
class VulcanHop: SpeedMode("VulcanHop", SpeedType.VULCAN) {
    ...
    override fun onUpdate() {
        ...
        if ((RotationUtils.targetRotation == null && Math.abs(mc.thePlayer.moveStrafing) < 0.1) || (RotationUtils.targetRotation != null && Math.abs(RotationUtils.getAngleDifference(MovementUtils.getMovingYaw(), RotationUtils.targetRotation.yaw)) < 45.0f)) {

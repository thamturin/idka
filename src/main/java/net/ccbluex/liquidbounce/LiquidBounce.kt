...
object LiquidBounce {
    ...
    const val CLIENT_FOLDER = "LiquidBounce-"
    const val CLIENT_VERSION = "0.2"
    const val CLIENT_CREATOR = "CCBlueX, PlusPlusMC, toidicakhia and his friends"
    ...
    fun startClient() {
        ...
        ClientUtils.getLogger().info("Startin't $CLIENT_NAME")
